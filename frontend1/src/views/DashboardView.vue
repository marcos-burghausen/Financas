...
let valueTotalExpensesMonth = ref(0);
let valueTotalRevenuesMonth = ref(0);
let totalCreditCard = ref(0);
let totalBalance = ref(0);
console.log(typeof (valueTotalExpensesMonth));

valueTotalExpensesMonth.value = data.valueTotalExpensesMonth;
valueTotalRevenuesMonth.value = data.valueTotalRevenuesMonth;
totalBalance.value = valueTotalRevenuesMonth - valueTotalExpensesMonth;
