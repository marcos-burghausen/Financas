<template>
  <v-layout>
    ...
    <!-- Main Content -->
    <v-main>
      <v-container fluid class="receitas-view pa-6">
        <!-- Header -->
        <v-row class="mb-4">
          <v-col cols="12">
        ...
        <v-row v-if="loading">
          <v-col cols="12" class="text-center py-12">
            ...
            <p class="text-grey mt-4">Carregando receitas...</p>
          </v-col>
        </v-row>
        ...
        <v-row v-else-if="filteredReceitas.length === 0">
          <v-col cols="12">
            <v-card elevation="2" class="text-center pa-12">
              <v-icon icon="mdi-cash-plus" size="80" color="grey-lighten-1" />
              <h3 class="text-h5 mt-4 mb-2">Nenhuma receita encontrada</h3>
              ...
              <div class="card-gradient card-gradient-success pa-4">
                <div class="d-flex align-center justify-space-between">
                  <div class="d-flex align-center">
                    ...
                    <div>
                      <h3 class="text-h6 text-white font-weight-bold">Listagem de Receitas</h3>
              ...
              >
                ...
                <template #item.actions="{ item }">
                  <div class="d-flex gap-1">
                    <v-tooltip text="Marcar como Recebida" location="top">
        ...
        <v-dialog v-model="dialog" max-width="700">
          <v-card>
            <div class="card-gradient card-gradient-success pa-4">
              <div class="d-flex align-center justify-space-between">
                <div class="d-flex align-center">
                  <v-icon icon="mdi-cash-plus" size="32" color="white" class="mr-3" />
                  <h2 class="text-h5 text-white font-weight-bold">
            ...
            <v-card-text class="pa-6">
              <v-form ref="form" @submit.prevent="saveReceita">
                <v-row>
                  <v-col cols="12">
                    <v-text-field
