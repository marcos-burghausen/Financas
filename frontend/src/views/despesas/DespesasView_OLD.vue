            ...
            <div class="d-flex align-center justify-space-between flex-wrap gap-3 mb-2">
              <div class="d-flex align-center flex-grow-1">
                ...
                <div class="header-content">
                  <h1 class="despesas-title mb-1 d-flex align-center">
                    <v-icon
                      icon="mdi-cash-minus"
                      ...
                      color="error"
                    />
                    <span class="d-none d-sm-inline">Minhas Despesas</span>
                    <span class="d-sm-none">Despesas</span>
                  </h1>
              ...
              <v-btn
                ...
                @click="openAddDialog"
              >
                <span v-if="!$vuetify.display.xs">Nova Despesa</span>
              </v-btn>
            </div>
          </v-col>
        </v-row>
