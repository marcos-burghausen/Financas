            ...
            <div class="d-flex align-center justify-space-between flex-wrap gap-3 mb-2">
              <div class="d-flex align-center flex-grow-1">
                ...
                <div class="header-content">
                  <h1 class="contas-title mb-1 d-flex align-center">
                    <v-icon 
                      icon="mdi-bank" 
        ...
        <v-row class="mb-6">
          ...
          >
            <v-card
              ...
              class="stat-card"
            >
              <div class="stat-card-gradient-info pa-3 pa-sm-4">
                <div class="d-flex align-center justify-space-between">
                  <div class="flex-grow-1">
                    <p class="text-caption text-white mb-1">
                      Tipos de Conta
                    ...
                    >
                      ...
                      <span class="d-none d-sm-inline">Diversificadas</span>
                      <span class="d-sm-none">Tipos</span>
                    </v-chip>
                  </div>
                  <v-avatar
                    color="rgba(255,255,255,0.2)"
                ...
                <div class="d-flex align-center justify-space-between mb-2">
                  <div class="d-flex align-center">
                    ...
                    <div>
                      ...
                      <p
                        class="text-caption text-white mb-0"
                        style="opacity: 0.9;"
                      >
                        {{ account.bank }}
                      </p>
